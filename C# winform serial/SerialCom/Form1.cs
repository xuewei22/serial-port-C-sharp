...
namespace SerialCom
{
    public partial class MainForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            paramters[1] = Convert.ToInt32(textBox1.Text);
            paramters[2] = Convert.ToInt32(textBox2.Text);
            paramters[3] = Convert.ToInt32(textBox3.Text);
            paramters[4] = Convert.ToInt32(textBox4.Text);
            paramters[5] = Convert.ToInt32(textBox5.Text);
            paramters[6] = Convert.ToInt32(textBox6.Text);
            paramters[7] = Convert.ToInt32(textBox7.Text);

            String[] strs = new String[3];

            strs[0] = "input," + Convert.ToString(paramters[1]) + ","
                               + Convert.ToString(paramters[2]) + ","
                               + Convert.ToString(paramters[3]) + ","
                               + Convert.ToString(paramters[4]);
            strs[1] = "times," + Convert.ToString(paramters[5]) + ","
                               + Convert.ToString(paramters[6]) + ","
                               + Convert.ToString(paramters[7]);


            strs[0] = "input,100,100,200,100";
            strs[1] = "times,100,100,100";
            strs[2] = "start";


            if (radioButtonSendDataASCII.Checked == true)//以字符串 ASCII 发送
            {
                serialPort.WriteLine(strs[0]);//发送一行数据 

                System.Threading.Thread.Sleep(100);

                serialPort.WriteLine(strs[1]);//发送一行数据 

                System.Threading.Thread.Sleep(100);

                serialPort.WriteLine(strs[2]);//发送一行数据 
            ...
            else
            {
                ...
                char[] values = strs[0].ToCharArray();
                foreach (char letter in values)
                {
                    // Get the integral value of the character.
                    int value = Convert.ToInt32(letter);
        ...
        private void groupBoxSendSetting_Enter(object sender, EventArgs e)
        {
